...
net_migration <- read_csv("data/tabula-md-statistical-handbook.csv", skip=2, col_names=c("state_or_jurisdiction", "july_2010", "july_2011", "july_2012", "july_2013", "july_2014", "july_2015", "july_2016", "july_2017", "july_2018", "april_2010_to_july_2019"))
View(net_migration)
```
...
**A1** The Suburban Washington Region has the largest percentage of international migration overall.

```{r}
# Write the code to produce your answer here
net_migration %>%
  mutate(percent_of_total= (april_2010_to_july_2019/198996)*100)
```

**Q2** Write a sentence or two that describes the data you produced in A1. Try to convey the most important idea.
**A2** The data above shows what percentage of the total international migration population resides in each region. 
...
**A3** Calvert had the biggest percentage change for international migration between July 2018 and July 2017, with a percent change of -76.923077.
...
**A4** These declines occurred because Calvert is a very conservative region of MD. If we look at this from a political context, it was very clear that Trump was very anti-immigrant, and his policies reflected that.  
...
```{r}
# Write the code to load the CSV file here
domestic_migration <- read_csv("data/tabula-md-statistical-handbook-domestic.csv", skip=2, col_names=c("state_or_jurisdiction", "july_2010", "july_2011", "july_2012", "july_2013", "july_2014", "july_2015", "july_2016", "july_2017", "july_2018", "april_2010_to_july_2019"))
...
**A5** Suburban Washington Region saw the largest net decrease in domestic migration overall. 

```{r}
# Write the code to produce your answer here
domestic_migration %>%
  arrange(april_2010_to_july_2019)
```
...
# Write the code to produce your answer here
domestic_migration %>%
  select(state_or_jurisdiction, july_2016, july_2017, july_2018) %>%
...
**A7** The data shows the regions and jurisdictions where more immigrants were coming into the region than out of it. Here, we see that, over a period of three years, Frederick had the highest net positive migration for July 2017, 2018 and 2019. 
