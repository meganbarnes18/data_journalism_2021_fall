...
A1: Charleston with 2837, South Charleston has 484, Saint Albans has 304, Dunbar with 166, Nitro with 142.
```{r}
...
A2: Jackson Kelly PLLC got the largest loan of 5,068,472 dollars. This zip code is located in Charleston, and 5,126,618.64 dollars in loans were forgiven. It's very interesting that the forgiveness amount is greater than the actual loan amount. I'm not sure I could explain the discrepancy and would have to ask the agency why this occurred. Otherwise, it looks like the business found a way to get more than they actually needed. 
...
A3: The five businesses are DUTCH MILLER OF CHARLESTON, INC, DUTCH MILLER CHEVROLET, INC., DUTCH MILLER OF CHARLOTTE, INC, DUTCH MILLER SUBARU, INC, and DM MOTOR INC. These businesses are all car dealerships. In total, the five businesses received 2,656,400	dollars total in loans. 101.1316 percent of the total loan amount has been forgiven, as 2,686,459 dollars was forgiven. Carol Miller, the U.S. House Member whose spouse owns these businesses, voted in favor of authorizing the PPP loan program.
