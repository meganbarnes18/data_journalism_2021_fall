...
**A4** There are more people in the first county compared to the second. 
...
**A5** Greenbriar Hotel Corporation got a loan of $8,912,202. It's categorized as a Corporation and the loan retained 500 jobs. 
...
**A6** Jim Justice; source: Wikipedia 
...
**A7** The only newsworthy thing that really jumps out is the total amount of loans distributed to the state. It's a pretty big number, so it could maybe be compared to other states' loans. You could also look at the minimum and maximum loan amounts and see what types of businesses got them and why. 
```{r}
# Write the code to produce your answer here
...
**A8** The most newsworthy nugget is which county got the most loans. Based on the data below, Kanawah had the most count loans, with 4,332 and total loan amount, with $420,270,037. I would then want to follow-up on how many jobs this big loan actually supoorted. It's newsworthy to know if these loans actually worked. 
```{r}
# Write the code to produce your answer here
wv_summary <- wv_ppp_loans
wv_ppp_loans %>%
