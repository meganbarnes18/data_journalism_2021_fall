...
**Answer** The output includes the person's username, the content of the tweet, when it was tweeted, what branch of government the user is in, their district, etc. 
...
**Answer** It shows the same lost of words, but 'cat' is only on there once. 
...
**Answer** The text was converted to lowercase and all punctuation was removed. 
...
**Answer** It shows that the most used word is 'the' which isn't a very interesting finding. 
...
**Answer** It's definitely more interesting than the word 'the'. 'covid' is the most used word, and all of the other words are somewhat related to it. 
...
**Answer** It shows the word, the number of times it appears, and its overall percentage. 
...
**Task** Run the following code and describe the results.
**Answer** Now the words are in pairs, and they're all centered around health. 
...
**Task** Run the following code and describe the results.
**Answer** Covid 19 is still at the top of the list and vaccine phrases are more apparent.  
...
**Task** Run the following code and describe the results.
**Answer** The lists are pretty similar for both parties. However, we see new phrases, such as 'social distancing' on the Democrat list and 'cares act' on the Republican list. This could show a difference in how each party addressed the pandemic. 
...
**Task** Run the following code and describe the results.
**Answer** Covid 19 is still at the top, but new phrases, such as 'illegal immigrants', 'joe biden', and 'biden administration' are now on the list. 
...
**Answer** This is all dependent on context, so its hard to tell if they're incorrect or counter-intuitive. For example, the word 'fall' could mean the season or a decrease in some variable. 
