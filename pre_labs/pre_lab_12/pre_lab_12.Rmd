...
**Answer** The code read in and produced a dataframe with 13 columns and 8530 rows. 
...
**Answer** There's a county called 'NA' that has 201 total, which is really interesting. The county totals 
...
**Answer** The tibble shows categories like vaccination_date, county, first_dose_daily, first_dose_cumulative, etc. I'm not fully sure what this data represents because there are no counties listed and none of the data lines up. For example, it says that there are no daily doses on a certain date but there's a high number of cumulative first doses. 
...
**Answer** The number of fully vaccinated people decreased with each day. There was a significant decrease between day 9 and day 10. 
...
**Answer** There were more total vaccinations earlier in the year, specifically in April. The numbers started to decrease in May/June. 
...
**Task** Run the following code and put the value of `sub` in the answer.
**Answer**
[1] "The number of people in Prince George's County fully vaccinated on November 14 decreased by -74.25 percent compared to the week before"
...
**Answer** The chart shows all of our counties and the relationship between date and number of cases. 
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** We now see a more accurate representation of the data, meaning the cases rising. 
...
**Answer** The map shows the number of COVID cases in each county of MD. We get to see which county has the most cases and which has the least. 
