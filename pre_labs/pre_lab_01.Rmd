...
**Answer** "name" is <chr> and "amount" is <dbl>. The name column may represent characters and the amount column may represent some sort of variable. 
...
**Answer**
5 companies got $10 million loans. The restaurant serves BBQ "fast food" according to Google.
