...
**Answer** I see 6 files of different types (.cpg, .dbf, .prj, .shp, .shx, .xml). 5 are documents and the last one is XML Text. This is all of the documentation on hospitals in the US and the number of beds they have. 
...
**Answer** The code read the layer. There are 33 columns in this data, with name, city, state, zip, telephone, type, status, population, county and beds being a few of the important ones. 
...
**Answer** The code tell us how many hospitals there are and how many fields they have. It shows us the first 10 hospitals and some information about each. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We get a chart with 7 rows, listing the type of hospital, the number of each type, and geometry. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It shows the 50 General Acute Care Hospitals and their features. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output was a scatter plot showing where the hospitals are located. It's kind of hard to tell where they are, but my best guess is in the middle of the state.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It says "To enable 
caching of data, set `options(tigris_use_cache = TRUE)` in your R script or .Rprofile.", but the code did run.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The code produced 3,233 rows and 18 columns, with information such as county names. It looks similar to the other file. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The code produced a dataset with only Maryland counties. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We have the same scatterplot, but we now have the outline of Maryland on top of it.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The points are now on top of the counties. Now we can see where the hospitals are located within the state. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We now have the multi-colored points on our map that show the number of beds at each hospital. 
...
**Answer** The libraries and Census API Key loaded
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It shows the first 10 features of our hospital layer. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We have a table of Maryland counties and their total beds. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We now have the population data for Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We have the geometry information with our top 10 features. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We see differences in cases in both datasets. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We now have a clean table, with a county column and the removal of the words Maryland and County. There is also the addition of the population column. The table is just more clean overall.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The NA's were converted to 0 in or table. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We have our data in order from highest to lowest, showing that Baltimore City has the higest population and total beds. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We have the same scatterplot from the previous chapter but, instead, it's a chloropleth map showing the number of beds per 100k in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We now have a clear color scheme that shows the difference in numbers. 
...
**Answer** The Eastern shore has the most beds per capita while Southern Maryland has the least. 
